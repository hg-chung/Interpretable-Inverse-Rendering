...
import numpy as np
from utils.graphics_utils import getWorld2View2, getProjectionMatrix, getProjectionMatrixShift, fov2focal

class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, cx, cy, light_position, light_intensity, image, gt_alpha_mask,
                 image_name, uid, 
        ...
        self.projection_matrix = getProjectionMatrixShift(znear=self.znear, zfar=self.zfar, focal_x=self.focal_x, focal_y=self.focal_y, \
